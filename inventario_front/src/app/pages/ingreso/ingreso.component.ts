...
export class IngresoComponent implements OnInit {
  ...
  Registrar(
    ...
    tipopagoCtrl?: any,
    formapagoCtrl?: any,
    fechaEmisionCtrl?: any,
    fechaVencimientoCtrl?: any,
  ) {
    // Marcar como tocados
    documentoCtrl?.control.markAsTouched();
    condicionCtrl?.control.markAsTouched();
    tipopagoCtrl?.control.markAsTouched();
    formapagoCtrl?.control.markAsTouched();
    fechaEmisionCtrl?.control.markAsTouched();
    fechaVencimientoCtrl?.control.markAsTouched();
